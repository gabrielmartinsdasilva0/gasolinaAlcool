...
ga=prompt("Digite o valor da bomba: 1 para Álcool e da bomba 2 para Gasolina", "Digite aqui");
...
if(ga==1){
    ...
    document.write(" Você solicitou " ,litros, " litros e o seu valor total será de R$ ", parseInt(total*100)/100);
}else if
(ga==2){
    total=litros*alcool;
    document.write(" Você solicitou " ,litros, " litros e o seu valor total será de R$ ", parseInt(total*100)/100);
